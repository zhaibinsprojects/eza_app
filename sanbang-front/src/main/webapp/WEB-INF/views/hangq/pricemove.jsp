...
<link href="front/resource/css/newAddcss/mui.poppicker.css" rel="stylesheet" />
 <script type="text/javascript" src="front/resource/js/newAddjs/pricemovezs.js"></script>
</head>
<body style="background:#efefef;width: 100%;/* background:#efefef;overflow-x: hidden; */">
  <!--实时报价--->
    ...
    <section class="secbjs_yzs">
  	<div id="container2" class="nedHC_new_yzs" style="min-width: 310px;"> </div>
  </section>
  <section class="secpri_yzs">
  	<table class="tabl_yzs_ud" cellpadding="0" cellspacing="0">
        ...
        <tbody>
        	<tr>
            	<td><span>2017-11-29</span></td>
                <td><span>******</span></td>
                <td><span class="sdown">跌</span></td>
                <td><span class="pdown">****%</span></td>
            </tr>
            <tr>
            	<td><span>2017-11-29</span></td>
                <td><span>******</span></td>
                <td><span class="sup">涨</span></td>
                <td><span class="pup">****%</span></td>
            </tr>
            <tr>
            	<td><span>2017-11-29</span></td>
                <td><span>******</span></td>
