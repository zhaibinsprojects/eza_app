...
.pj_mess .pj_h3{color:#333333;font-size:16px;font-weight:bold;margin-bottom:60px;}
...
<div class="content_yzs">
  ...
  <div class="pj_mess">
  	<img src="front/resource/img/pj_error.png" class="pj_img"/>
  	<div class="pj_h3">提交失败，请重新进行申请</div>
