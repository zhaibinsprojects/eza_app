http://10.10.10.95/front/app/goods/toGoodsShow.htm?id=108&token=appcs115827002021MsYOxuVureFOU3c8s7UnHMPfKIBteQdp<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
...
<body style="background:#efefef;">
	...
	<div class="ezsm-shopdetail-param">
		<table cellspacing="0">
			...
			<tr> <td>上批货品质检结果</td> <td><span  onclick="showpdf(${good.id})"  class="colorgreen" style="margin-right:20px;">质检报告</span></td> </tr>
