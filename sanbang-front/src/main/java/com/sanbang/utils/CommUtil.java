...
public class CommUtil {
	...
	public static final String sample_goods = "SAMPLE_GOODS";				//样品
	
	public static final String self_goods = "SELF_GOODS"; 					// 自营商品
	public static final String self_sample_goods = "SELF_SAMPLE_GOODS";		// 自营样品
	
	public static final String match_goods = "MATCH_GOODS";					// 供应商商品
	public static final String match_sample_goods = "MATCH_SAMPLE_GOODS";	// 供应商样品
