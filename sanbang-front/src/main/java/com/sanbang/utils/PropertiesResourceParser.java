 ...
 * <p>本接口要求其实现类即可解析已加载的{@link Resource}类型的属性文件资源，同时也可解析指定路径下的属性文件资源。
 * 对于解析的结果可以返回包含属性信息的任何类型。如返回{@code Map<String,String>}类型结果的MapPropertiesResourceParser解析器。
 * </p>
