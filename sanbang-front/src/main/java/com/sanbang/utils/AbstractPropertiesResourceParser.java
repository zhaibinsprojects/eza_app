 ...
 * <p>AbstractPropertiesResourceParser中定义了两个属性：encoding和resourceLoader：
 * <ul>
 * 	<li>encoding:是指在读取属性文件时，为{@link InputStreamReader}设置读取字节的编码格式。</li>
 *  <li>resourceLoader:指定读取属性文件的资源加载器,默认使用{@link PathMatchingResourcePatternResolver}来解析path获得属性资源。</li>
 * </ul>
